...
INSERT OVERWRITE LOCAL DIRECTORY '../data/AreaMap'
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
select Borough, cast(Block as int), cast(Lot as int), ZipCode, cast(LotArea as bigint), cast(ComArea as bigint), cast(ResArea as bigint)
from PlutoInput
